...
export class Backend implements backendInterface {
    ...
    async addAuditStep(arg0: string, arg1: string, arg2: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addAuditStep(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async addBlogPost(arg0: string, arg1: string, arg2: string, arg3: Time, arg4: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async addTeamMember(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllAuditSteps(): Promise<Array<AuditStep>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllAuditSteps();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateSiteStats(arg0: bigint, arg1: bigint, arg2: bigint, arg3: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateSiteStats(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
